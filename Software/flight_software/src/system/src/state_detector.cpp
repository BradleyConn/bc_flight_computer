...
bool StateDetector::check_liftoff_detected(const bmi088DatasetConverted& data)
{
    ...
    float magnitude = sqrt(data.accel_data_converted.x_mg * data.accel_data_converted.x_mg + data.accel_data_converted.y_mg * data.accel_data_converted.y_mg + data.accel_data_converted.z_mg * data.accel_data_converted.z_mg);
